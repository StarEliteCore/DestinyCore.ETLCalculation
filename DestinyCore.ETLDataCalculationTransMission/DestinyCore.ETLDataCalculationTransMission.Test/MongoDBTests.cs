...
using DestinyCore.ETLDataCalculationTransMission.Shared.Audit;
using DestinyCore.ETLDataCalculationTransMission.Shared.Entity;
using DestinyCore.ETLDataCalculationTransMission.Shared.ExpressionUtil;
using DestinyCore.ETLDataCalculationTransMission.Shared.Extensions.OrderExtensions;
using DestinyCore.ETLDataCalculationTransMission.Shared.Filter;
using DestinyCore.ETLDataCalculationTransMission.TestBase;
using System;
using System.IO;
using System.Threading.Tasks;
using Xunit;

namespace DestinyCore.ETLDataCalculationTransMission.Test
{
    public class MongoDBTests : IntegratedTest<MongoDBModelule>
    {
        ...
        public async Task GetPageAsync_Test()
        {
            ...
            OrderCondition[] orderConditions = new OrderCondition[] {
                new OrderCondition("Name",DestinyCore.ETLDataCalculationTransMission.Shared.Enums.SortDirectionEnum.Descending),

...
using DestinyCore.ETLDataCalculationTransMission.Application;
using DestinyCore.ETLDataCalculationTransMission.AspNetCore.ApiBase;
...
namespace DestinyCore.ETLDataCalculationTransMission.API.Controllers.DataDictionary
{
    [Description("数据字典管理")]

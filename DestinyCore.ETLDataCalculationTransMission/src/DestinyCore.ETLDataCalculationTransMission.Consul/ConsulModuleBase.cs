...
using DestinyCore.ETLDataCalculationTransMission.Shared.ConsulEntity;
...
using DestinyCore.ETLDataCalculationTransMission.Shared.Network;
using System;

namespace DestinyCore.ETLDataCalculationTransMission.Consul
{

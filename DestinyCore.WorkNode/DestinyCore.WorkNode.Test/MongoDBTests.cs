...
using DestinyCore.WorkNode.Shared.ExpressionUtil;
using DestinyCore.WorkNode.Shared.Extensions.OrderExtensions;
using DestinyCore.WorkNode.Shared.Filter;
using DestinyCore.WorkNode.TestBase;
using System;
using System.IO;
using System.Threading.Tasks;
using Xunit;

namespace DestinyCore.WorkNode.Test
{
    public class MongoDBTests : IntegratedTest<MongoDBModelule>
    {
        ...
        public async Task GetPageAsync_Test()
        {
            ...
            OrderCondition[] orderConditions = new OrderCondition[] {
                new OrderCondition("Name",DestinyCore.WorkNode.Shared.Enums.SortDirectionEnum.Descending),

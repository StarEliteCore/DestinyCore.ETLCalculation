...
using DestinyCore.ETLCalculation.Shared.Audit;
using DestinyCore.ETLCalculation.Shared.Entity;
using DestinyCore.ETLCalculation.Shared.ExpressionUtil;
using DestinyCore.ETLCalculation.Shared.Extensions.OrderExtensions;
using DestinyCore.ETLCalculation.Shared.Filter;
using DestinyCore.ETLCalculation.TestBase;
using System;
using System.IO;
using System.Threading.Tasks;
using Xunit;

namespace DestinyCore.ETLCalculation.Test
{
    public class MongoDBTests : IntegratedTest<MongoDBModelule>
    {
        ...
        public async Task GetPageAsync_Test()
        {
            ...
            OrderCondition[] orderConditions = new OrderCondition[] {
                new OrderCondition("Name",DestinyCore.ETLCalculation.Shared.Enums.SortDirectionEnum.Descending),

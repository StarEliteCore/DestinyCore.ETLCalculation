...
namespace DestinyCore.ETLCalculation.MultiTenancy
{
    public class DefaultSuktConnectionStringResolver : ISuktConnectionStringResolver
    {
        ...
        public string Resolve()
        {
            ...
            string connectionString = "server=10.1.40.207;userid=test;pwd=pwd123456;database=DestinyCore.ETLCalculation;connectiontimeout=3000;port=3307;Pooling=true;Max Pool Size=300; Min Pool Size=5;";

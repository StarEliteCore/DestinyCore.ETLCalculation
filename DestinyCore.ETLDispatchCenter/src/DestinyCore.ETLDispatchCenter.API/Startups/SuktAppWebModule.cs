...
using DestinyCore.ETLDispatchCenter.Aop;
using DestinyCore.ETLDispatchCenter.AspNetCore.Filters;
using DestinyCore.ETLDispatchCenter.AutoMapper;
using DestinyCore.ETLDispatchCenter.Domain.Models;
...
using DestinyCore.ETLDispatchCenter.Swagger;
using System;
using System.Linq;

namespace DestinyCore.ETLDispatchCenter.API.Startups
{
    [SuktDependsOn(
        typeof(AopModule),

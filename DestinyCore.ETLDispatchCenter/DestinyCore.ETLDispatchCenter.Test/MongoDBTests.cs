...
using DestinyCore.ETLDispatchCenter.MongoDB;
...
using DestinyCore.ETLDispatchCenter.Shared.ExpressionUtil;
using DestinyCore.ETLDispatchCenter.Shared.Extensions.OrderExtensions;
using DestinyCore.ETLDispatchCenter.Shared.Filter;
using DestinyCore.ETLDispatchCenter.TestBase;
using System;
using System.IO;
using System.Threading.Tasks;
using Xunit;

namespace DestinyCore.ETLDispatchCenter.Test
{
    public class MongoDBTests : IntegratedTest<MongoDBModelule>
    {
        ...
        public async Task GetPageAsync_Test()
        {
            ...
            OrderCondition[] orderConditions = new OrderCondition[] {
                new OrderCondition("Name",DestinyCore.ETLDispatchCenter.Shared.Enums.SortDirectionEnum.Descending),
